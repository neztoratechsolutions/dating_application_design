...
export const Route = createFileRoute("/legal/privacy")({
  component: () => (
    <div className="prose prose-invert max-w-none">
      ...
      <p className="text-sm leading-relaxed">We respect your privacy. We collect only what's needed to provide our services: account info, usage data, and payment details. Your data is never sold.</p>

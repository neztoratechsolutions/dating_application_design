...
export const Route = createFileRoute("/legal/terms")({
  component: () => (
    <div className="prose prose-invert max-w-none">
      ...
      <p className="text-sm leading-relaxed">By using Velora Live you agree to behave respectfully, follow community guidelines, and accept that coins are non-refundable once used.</p>
